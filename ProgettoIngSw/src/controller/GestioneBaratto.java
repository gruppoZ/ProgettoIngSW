...
public class GestioneBaratto {
	 ...
	 * @return
	 */
	public Baratto getBarattoByOffertaSelezionata(Offerta offertaSelezionata) {
		for (Baratto baratto : listaBaratti) {
	 ...
	 * @return data di scadenza
	 */
	public LocalDate getDataScadenza(GestioneParametri gestorePiazza, Appuntamento appuntamento) {
	 ...
	 * @throws IOException 
	 */
	public void aggiornaBaratto(Baratto barattoDaAggiornare, Offerta offertaA, Offerta offertaB, LocalDate dataScadenza, Appuntamento appuntamento) throws IOException {
	 ...
	 * @throws IOException 
	 */
	public void aggiornaBaratto(Baratto barattoDaAggiornare, LocalDate dataScadenza, Appuntamento appuntamento) throws IOException {		
		barattoDaAggiornare.setAppuntamento(appuntamento);
		barattoDaAggiornare.setScadenza(dataScadenza);
	 ...
	 * @throws IOException 
	 */
	public void creaBaratto(Offerta offertaA, Offerta offertaB, int scadenzaInGiorni) throws IOException {
