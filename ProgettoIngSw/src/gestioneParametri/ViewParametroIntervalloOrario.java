...
public class ViewParametroIntervalloOrario extends ViewParametri{
	...
	private static final String MSG_INTERVALLO_RIMOSSO = "Intervallo rimosso";
	private static final String MSG_INTERVALLI_SOVRAPPOSTI = "L'intervallo inserito si sovrappone con gli intervalli gia' presenti";
	...
	public void rimuovi() {
		...
		System.out.println("Inserire l'orario iniziale dell'intervallo da rimuovere");
		LocalTime orarioMinDaEliminare = creaOrarioMin(LocalTime.MIN, LocalTime.of(23, 0));
		System.out.println("Orario iniziale dell'intervallo da eliminare: " + orarioMinDaEliminare.toString());
	...
	private static int scegliMinuti(int ora) {
		int minuti = 0;
	...
	LocalTime creaOrarioMin(LocalTime min, LocalTime max) {
	...
	LocalTime creaOrarioMax(LocalTime min, LocalTime max) {
		int ora;
		int minuti;
